...
I specialize in:
- Building clean, user-focused dashboards with Power BI
- Automating repetitive business tasks using RPA tools like UiPath
- Developing secure and scalable APIs with .NET technologies
- Ensuring quality software delivery through manual and automated testing
- Managing small-to-medium tech projects with attention to performance and usability
...
- **Automation & Testing:** UiPath, Selenium, Postman, Manual Testing
- **DevOps & Tools:** GitHub, Visual Studio, Azure (Basics), REST APIs
- **Project Skills:** Agile methodologies, documentation, system analysis
...
GPA: 65%  
Focus: Software Development, Databases, Networks, Automation  
Projects: ASP.NET, UiPath, SQL Server, Power BI
...
_“Transforming data into insight, automation into efficiency, and code into impactful solutions.”_
